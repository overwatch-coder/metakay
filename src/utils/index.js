...
export const products = [
    ...
    {
        images: [col41, col42, col43], 
        category: ['woman', 'trousers', 'eunoia'], 
        photo: product20, 
        slug: 'product-twenty', 
        name: 'Product Twenty', 
        price: 760.00
