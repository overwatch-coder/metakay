...
const SingleCollection = ({photo, description, breakPoints, name, images}) => {
  return (
    <div className='relative group'>
        ...
        <div className='opacity-0 transition duration-1000 group-hover:opacity-100 py-16 md:py-24 px-3 md:px-10 text-left absolute top-0 right-0 bg-gray w-[300px] text-white mix-blend-luminosity md:w-1/2 rounded-md shadow-xl drop-shadow-2xl'>
